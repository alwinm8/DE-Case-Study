...
hdfs dfs -mkdir -p /Credit_Card_System/

#delete all files in credit card system directory if exists
hdfs dfs -rm -r -f /Credit_Card_System/*
...
hdfs dfs -mv /Credit_Card_System/CDW_SAPP_D_CUSTOMER/part-m-00000 /Credit_Card_System/CDW_SAPP_CUSTOMER.txt
hdfs dfs -mv /Credit_Card_System/CDW_SAPP_D_BRANCH/part-m-00000 /Credit_Card_System/CDW_SAPP_BRANCH.txt
hdfs dfs -mv /Credit_Card_System/CDW_SAPP_D_TIME/part-m-00000 /Credit_Card_System/CDW_SAPP_TIME.txt
hdfs dfs -mv /Credit_Card_System/CDW_SAPP_F_CREDIT_CARD/part-m-00000 /Credit_Card_System/CDW_SAPP_CREDITCARD.txt
